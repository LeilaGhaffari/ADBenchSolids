...
void compute_f_analytic(int Q, const double mu, const double lambda, double *dXdx_init, double *dudX, int num_comp_stored, double *stored_values, double *f1);
void compute_df_analytic(int Q, const double mu, const double lambda, double *ddudX, int num_comp_stored, double *stored_values, double *df);
